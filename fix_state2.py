...
pattern = re.compile(r'async function loadAndGroupAllProductsDesktop\(isLoadMore = false\) \{.*?(?=function generateStars)', re.DOTALL)

# Inject the fixed block
content = pattern.sub(new_block + "\n\n        ", content)

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)

print("Fixed isLoadingMore conflict successfully.")
